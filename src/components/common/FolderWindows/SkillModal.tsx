          ...
          {skillCategories.map((category) => (
            <div key={category.name} className="border border-gray-500/30 rounded-lg overflow-hidden bg-gray-900">
              <button
                ...
                className="w-full tw-full p-4 flex items-center justify-between hover:bg-gray-800 transition-colors text-left font-semibold text-lg hover:underline"
              >
                <span className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-300">{category.skills.length} skills</p>
                  </div>
